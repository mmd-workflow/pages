...
export default defineConfig({
  ...
  head:[
    ...
    ['meta', { property: 'og:image', content: 'https://mmd-workflow.github.io/pages/images/logo_og.png' }],
    // Twitter Meta Tags
    ['meta', { name: 'twitter:card', content: 'summary_large_image' }],
    ['meta', { name: 'twitter:title', content: 'MMD Workflow' }],
    ['meta', { name: 'twitter:description', content: 'MMD Workflow Tools' }],
    ['meta', { name: 'twitter:image', content: 'https://mmd-workflow.github.io/pages/images/logo_og.png' }],
  ],
  themeConfig: {
